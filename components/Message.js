...
//         fetch('https://strangers-things.herokuapp.com/api/2211-FTB-ET-WEB-AM/posts/63edf01d9620QQQQQQQQQa10015337878/messages', {
//   method: "POST",
//   headers: {
...
// message();
    ...
    return(
        <>
                <p>Message Sent</p>
        <form>
            <input id="reply" type="text" placeholder="Type message here."></input>
